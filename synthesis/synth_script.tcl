...
dfflibmap -liberty /home/vishwa/OpenROAD/test/Nangate45/Nangate45_typ.lib

# 5. Map logic to Sky130HD cells
abc -liberty /home/vishwa/OpenROAD/test/Nangate45/Nangate45_typ.lib

# 6. Cleanup
clean

# 7. Reports
tee -o reports/synth_stat.rpt stat -liberty /home/vishwa/OpenROAD/test/Nangate45/Nangate45_typ.lib
